                ...
                <div class="col-xl-4 col-lg-4 col-md-4 box-mem">
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            @endphp
                            <li class="list-group-item"><i class="icon ion-ios-arrow-round-forward icon-small"></i><span>Unlimited access to the gym: {{ $features->unlimited_access ? 'Yes' : 'No' }}</span></li>
                            <li class="list-group-item"><i class="icon ion-ios-arrow-round-forward icon-small"></i><span>{{ $features->classes_per_week }} classes per week</span></li>
                            <li class="list-group-item"><i class="icon ion-ios-arrow-round-forward icon-small"></i><span>{{ $features->free_personal_training }} Free personal training</span></li>
                            <li class="list-group-item"><i class="icon ion-ios-arrow-round-forward icon-small"></i><span>Free drinking package: {{ $features->free_drinking_package ? 'Yes' : 'No' }}</span></li>
                        </ul>                        <div class="sign-up-pre">
