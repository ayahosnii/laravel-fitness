...
<div class="page-heading">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <span style="font-size: 25px">Girly</span>
                <h2>Exercise online</h2>
                <span>Home > {{--<a href="{{route('exercises')}}">Exercises</a>--}}</span>
            </div>
        </div>
    </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-5">
                <div class="section-heading">
                    ...
                    <h2>Discover Some Of Our <em>Exercies</em>.</h2>
                </div>
            </div>
            <div class="col-lg-7">
            ...
            <div class="col-lg-4">
                ...
                <span class="author">
                  <img src="assets/images/author.jpg" alt="" style="max-width: 50px; max-height: 50px; border-radius: 50%;">
                            ...
                            <img src="{{asset($ex->image)}}" alt="" style="border-radius: 20px;">
                            <h4>{{$ex->name}} ({{ $ex->exercises()->count()}})</h4>
                        </div>
                        <div class="col-lg-12">
                            <div class="line-dec"></div>
                            <div class="row">
                                <div class="col-6">
                                    <span>Burn: <br> <strong>{{($ex->getSum('MET', $ex->id) * ($ex->getSum('counter', $ex->id)/60) * $weight->weight) / 200}} Cal</strong></span>
                                </div>
                                <div class="col-6">
                                    <span>Time: <br> <strong>
                                            {{$ex->getSum('counter', $ex->id)}} Sec </strong></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="main-button">
                                <a href="{{route('exercises', $ex->id)}}">Exercise Now</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <span class="author">
                  <img src="assets/images/author.jpg" alt="" style="max-width: 50px; max-height: 50px; border-radius: 50%;">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <span>Burn: <br> <strong>250 Cal</strong></span>
                                </div>
                                <div class="col-6">
                                    <span>Time: <br> <strong> 30 Min</strong></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                ...
                <span class="author">
                  <img src="assets/images/author.jpg" alt="" style="max-width: 50px; max-height: 50px; border-radius: 50%;">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <span>Burn: <br> <strong>100 Cal</strong></span>
                                </div>
                                <div class="col-6">
                                    <span>Time: <br> <strong>15 Min</strong></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                ...
                <span class="author">
                  <img src="assets/images/author.jpg" alt="" style="max-width: 50px; max-height: 50px; border-radius: 50%;">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    <span>Burn: <br> <strong>75 Cal</strong></span>
                                </div>
                                <div class="col-6">
                                    <span>Time: <br> <strong>10 Min</strong></span>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-heading">
                    <div class="line-dec"></div>
                    <h2>Our Top Fitness This Week.</h2>
                </div>
            </div>
            <div class="col-lg-3 col-sm-6">
                <div class="row">
