...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::post('/food-dairy/add-breakfast/store', [\App\Http\Controllers\FoodDairyController::class, 'breakfast'])->name('dairy.breakfast.store');
    Route::get('/food-dairy/add-lunch', [\App\Http\Controllers\FoodDairyController::class, 'lunch'])->name('dairy.lunch');
    Route::post('/food-dairy/add-lunch/store', [\App\Http\Controllers\FoodDairyController::class, 'lunch'])->name('dairy.lunch.store');
    Route::get('/food-dairy/add-dinner', [\App\Http\Controllers\FoodDairyController::class, 'dinner'])->name('dairy.dinner');
    Route::post('/food-dairy/add-dinner/store', [\App\Http\Controllers\FoodDairyController::class, 'dinner'])->name('dairy.dinner.store');
